    ...
    <section className={styles.section} ref={program}>
      <Container>
        ...
        <div className={styles.container__description}>
          <p className={styles.program__description}>{t('section.program.description')}</p>
          <p className={styles.program__description}>{t('section.program.descriptionHelp')}</p>
          <p className={styles.program__description}>{t('section.program.descriptionHelpNow')}</p>
        </div>

        <div className={styles.diagrama}>
          <p className={styles.diagrama__help}> {t('section.program.nowHelp')}</p>
          <p className={styles.diagrama__need}> {t('section.program.needHelp')}</p>
        </div>

        <div className={styles.diagrama__description}>
          <p className={styles.help__now}> {t('section.program.nowHelpDescription')}</p>
          <p className={styles.help__need}> {t('section.program.needHelpDescription')}</p>
        </div>
        <h3 className={styles.cost__title}>{t('section.program.cost.title')}</h3>
        <div className={styles.cost__container}>
          ...
          <div className={styles.cost__all}>
            <p className={styles.all__description}>{t('section.program.cost.allDescription')}</p>
            <p className={styles.all__sum}>{t('section.program.cost.all')}</p>
          </div>
        </div>
        <Button className={styles.btn__assistance}>{t('section.program.assistance')}</Button>
      </Container>
    </section>
  );
};
